    ...
    <SafeAreaView style={styles.bodyContainer}>
      <ScrollView showsHorizontalScrollIndicator={false}>
        <View style={{ paddingHorizontal: 20 }}>
          <Text style={styles.fourthText}>CGPA Calculator</Text>
          <Text style={styles.secondText}>
            Calculate and keep record of your grades
          </Text>

          <View style={styles.container}>
            <Text style={styles.firstText}>{totalCGPA}</Text>
            <Text style={styles.thirdText}>Total CGPA</Text>
          </View>
          <TouchableOpacity
            style={styles.button}
            ...
            {cgpaRecords.map((record, index) => (
              <View key={index} style={styles.secondContainer}>
                ...
                >
                  ...
                  >
                    <TouchableOpacity
                      onPress={() => handleDelete(record.level, record.course)}
                    >

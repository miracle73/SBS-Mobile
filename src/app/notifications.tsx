...
import { ProcessedNotification } from "../types/notification";

// Remove NotificationScreenProps interface dependency since we're using expo-router
const NotificationScreen: React.FC = () => {
  // Changed from 'notifications' to 'NotificationScreen'
...
export default NotificationScreen; // Changed export name

  ...
  if (isSingleImage) {
    ...
    return (
      <View style={{ alignItems: "center", justifyContent: "center" }}>
        <Image
          source={{ uri: `https://sbsapp.com.ng/${searchResults}` }}
          style={styles.image}
        />
      </View>
    );
  ...
  return (
    <SafeAreaView style={styles.bodyContainer}>
      <ScrollView style={{ paddingHorizontal: 20 }}>
        ...
        >
          {searchResults.image_1 && (
            <Image
              source={{ uri: `https://sbsapp.com.ng/${searchResults.image_1}` }}
              style={styles.image}
            />
          )}
        </View>
        ...
        >
          {searchResults.image_2 && (
            <Image
              source={{ uri: `https://sbsapp.com.ng/${searchResults.image_2}` }}
              style={styles.image}
            />
          )}
        </View>
        ...
        <View style={{ alignItems: "center", justifyContent: "center" }}>
          {searchResults.image_3 && (
            <Image
              source={{ uri: `https://sbsapp.com.ng/${searchResults.image_3}` }}
              style={styles.image}
            />
          )}
          {searchResults.image_4 && (
            <Image
              source={{ uri: `https://sbsapp.com.ng/${searchResults.image_4}` }}
              style={styles.image}
            />
          )}
          {searchResults.image_5 && (
            <Image
              source={{ uri: `https://sbsapp.com.ng/${searchResults.image_5}` }}
              style={styles.image}
            />
          )}
        </View>

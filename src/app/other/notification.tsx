  ...
  const notifications = [
    {
      ...
      content:
        "Your pin is #576847. Use this to activate your account right now.",
      time: "1m ago",
    },
    {
      id: "2",
      ...
      content:
        "Your subscription pin is #123456. Please renew to continue enjoying premium features.",
      time: "10m ago",
    },
    {
      id: "3",
      ...
      content:
        "Activate your account using pin #987654 to explore all features!",
      time: "2h ago",
    },
  ];

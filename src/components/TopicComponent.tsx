...
import { useGetTopicContentMutation, useUserActivatedStatusMutation } from '../components/services/userService';
...
const TopicComponent: React.FC<TopicComponentProps> = ({ title, id, free, courseName, level }) => {

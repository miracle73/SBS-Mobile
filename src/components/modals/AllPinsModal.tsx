...
const AllPinsModal = ({ setModal, modal }: AllPinsModalProps) => {
            ...
            <TouchableOutside onPress={() => setModal(false)}>
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                        ...
                        <Text style={styles.firstText}>Pin copied</Text>
                        <Text style={styles.secondText}>You have successfully copied a pin</Text>
